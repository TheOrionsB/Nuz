<template>
    <div class="w-full h-full p-[5%] space-y-10">
        <div class="space-y-1 flex flex-col ">
            <h1 class="font-bold text-4xl ">Create a new link</h1>
            <p class="text-purple-300 text-2xl">If you don't want your link to expire or to be password protected, leave their
                optionnal fields empty.</p>
        </div>
        <form class="flex flex-col space-y-4 text-xl" @submit.prevent="createLink">
