<template>
    <main>
        <div class="h-screen w-screen bg-gradient-to-br from-indigo-900 via-black to-black">
            <div class="h-screen w-screen bg-transparent flex flex-col items-center overflow-x-hidden">
                <HeaderGlobal v-if="headerVisible" />
...
watch(route, () => {
    if (route.path === '/dash') headerVisible.value = false;
    else headerVisible.value = true;
})
